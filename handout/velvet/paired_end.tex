...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{de_novo/handout/velvet/paired_fastqc.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{de_novo/handout/velvet/paired_fastqc_quality_plots.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{de_novo/handout/velvet/velvet_Rplot002.png}
