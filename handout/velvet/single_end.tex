...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{de_novo/handout/velvet/velvet_Rplot001.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{de_novo/handout/velvet/hawkeye_single_ended.png}
...
\begin{advanced}
\input{de_novo/handout/velvet/simple_simulation.tex}
\end{advanced}
